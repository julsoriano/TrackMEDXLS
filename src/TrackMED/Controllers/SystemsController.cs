...
namespace TrackMED.Controllers
{
    ...
    public class SystemsController : Controller
    {
        ...
        public SystemsController(IEntityService<SystemTab> entityService,
        ...
        */
        ...
        //public static void InitializeMongoDB(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                ...
                for (int iSheet = 20; iSheet <= wsCnt; iSheet++)
                {
                                        ...
                                        case "Calibration":
                                            if (c.CalibrationDate != null)
                                            {
                                                if (c.CalibrationDate < ea.WO_Calculated_Due_Date)
                                                {
                                                    ...
                                                    c.ServiceProviderID = ea.ServiceProviderID;
